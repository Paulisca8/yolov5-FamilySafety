...
@torch.no_grad()
def run(
        weights=ROOT / 'models/yolov5s_person_fire_demo1.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'models/yolov5s_person_fire_demo1.pt', help='model path(s)')
